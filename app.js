...
const reviews = [
  ...
  
  {
    ...
    // answer:"* -> + -> * "
    title:"Identify",
    question:"Guess the name of the CEO",
  ...
  },
  {
    id: 3,
    title:"Question" ,
    question: "What does the term Wi-Fi stand for in networking?",
  ...
  },
  {
    ...
    question:" What is the purpose of a modem in a computer network?\n\
              a-Connecting multiple computers within a local area network\n\
              b-Providing wireless connectivity to devices\n\
              c-Converting digital signals to analog signals for transmission over telephone lines\n\
              d-Managing internet traffic within a network" ,
    answer:"Converting digital signals to analog signals for transmission over telephone lines",
  },
  {
    id: 10,
    ...
    question:"What is the difference between a virus and malware?\n\
      A) Malware is specific to computers, while viruses can infect any device\n\
      B) Viruses require user interaction to spread, while malware can spread automatically\n\
      C) Viruses replicate themselves, while malware may include various types of malicious software\n\
      D) Malware is always harmful, while viruses can sometimes be beneficial",
    answer:"Viruses replicate themselves, while malware may include various types of malicious software"
  ...
  },
  {
    ...
    //  answer:"(8,0,0) -> (5,0,3) -> (5,3,0) -> (2,3,3) -> (2,5,1) -> (7,0,1) -> (7,1,0) -> (4,1,3)"
     title:"Question" ,
     question:"Who discovered C language. ",
  ...
  },
  {
    ...
    title:"Question",
    question:"Which of the following programming languages is often used for creating mobile applications?",
    answer:"JAVA"
  },
